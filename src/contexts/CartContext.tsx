...
const localStorageKey = '@CaduLanches:carrinho'
...
export function CartProvider({ children }: CartProviderProps) {
    ...
    function addSnackIntoCart(snack: SnackData): void {
        ...
        if (snackExistentInCart) {
            ...
            toast.success(`+1 ${snackEmoji(snack.snack)} ${snack.name} adicionado(a) nos pedidos!`)
            saveCart(newCart)
        ...
        toast.success(`${snackEmoji(snack.snack)} ${snack.name} adicionado(a) nos pedidos!`)
        saveCart(newCart)
    }
